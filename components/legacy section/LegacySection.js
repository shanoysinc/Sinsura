	...
	return (
		<div className={styles.container}>
			<div className={styles.innerContainer}>
				<p className={styles.subTitle}>Hasura for enterprises</p>
				<h3 className={styles.title}>
					Activate Legacy Data with GraphQL
				</h3>
				<p className={styles.paragraph}>
					Hasura is used in mission critical applications across
					Fortune 500 companies and is helping enterprises teams
					deliver on their strategic initiatives.
				</p>

				<div className={styles.btnContainer}>
					<a href="/">
						<button className={styles.btn}>talk to sales</button>
					</a>
				</div>
				<FeatureItems
				...
				/>
				<BlogCard image="/svg/card_icon_3.svg" content="workshop" />
			</div>
		</div>
	);
};
